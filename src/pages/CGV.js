    ...
    <Row>
        <Col>  
            ...
            <ol>
                ...
                <ul>
                    <li>Cas de force majeure (en ce compris, notamment, les grèves, incidents d’ordre technique, retard du fournisseur et pénurie de main-d’oeuvre);</li>

                    <li>Non-respect des conditions de paiement;</li>

                    <li>Changements décidés par le client en cours de travail;</li>

                    <li>Non-fourniture des informations souhaitées endéans le délai spécifié;</li>
                </ul>
                </p>
                
                <li>Livraison – Fourniture</li>
                <p>
                ...
                <li>Clause de réserve de propriété</li>
                <p>
                ...
                <li>Résiliation-résolution aux torts d’un cocontractant</li>
                <p>
                ...
                <li>Changements de la convention</li>
                <p>
